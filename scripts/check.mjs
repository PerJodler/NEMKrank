...
requireText(html.includes("<title>VitaChronik – Design 05 Berry Brain</title>"), "Seitentitel fehlt.");
...
requireText(html.includes("dataset.design = 'berry'"), "Das feste App-Design fehlt.");
